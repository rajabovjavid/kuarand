                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            while ($uruncek = $urunsor->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><a href="urun-galeri.php?urun_id=<?php echo $uruncek['urun_id'] ?>">
                                                <button class="btn btn-success btn-xs">Resim İşlemleri</button>
                                            </a></center>
                                    </td>
                                    <td>
                                        <center><?php
                                    ...
                                    <td>
                                        <center><a href="urun-duzenle.php?urun_id=<?php echo $uruncek['urun_id']; ?>">
